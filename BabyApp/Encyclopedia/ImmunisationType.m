...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cell==nil)
    {
        ...
        lblName=[[UILabel alloc] initWithFrame:CGRectMake(10,5, immunisationDetailTable.frame.size.width-30, 35)];
        lblName.tag=10;
        ...
        lblName2=[[UILabel alloc] initWithFrame:CGRectMake(10,30,immunisationDetailTable.frame.size.width-30, 80)];
        lblName2.tag=20;
